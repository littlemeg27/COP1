...
namespace Debug_Exercise
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DisplayUserInfo(name, age); //Changed ag to age 
        ...
        public static void DisplayUserInfo(string who, int age)
        {
            ...
            Console.WriteLine(names + ", on the occasion of turning " + age + " years old!"); //Changed to age and names 
        }
        ...
        {
            for (int index = 97; index <= 122; index++) //Changed from what it was to index
            {
                if ((index + 3) % 10 == 0)
                {
                    Console.WriteLine();
